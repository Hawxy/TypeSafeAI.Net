...
- The API key, base URL and default model are set through `TypeSafeClientOptions`, configuration binding, or the `AddTypeSafeClient` overloads; the client does not read environment variables.
